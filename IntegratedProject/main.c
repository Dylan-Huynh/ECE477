...
#define BLUETOOTHMESSAGESIZE2 28
...
uint8_t gamefinishedMessage[MESSAGESIZE] = {0x42, 0x54, 0x30, 0x31, 0x35, 0x01, 0x00, 0x00, 0x21, 0x41, 0x41, 0x33, 0x41, 0x00,
								 0x20, 0x00, 0x20, 0x47, 0x00, 0x61, 0x00, 0x6d, 0x00, 0x65, 0x00, 0x20, 0x00, 0x4F, 0x00, 0x76,
								 0x00, 0x65, 0x00, 0x00, 0x72, 0x00, 0x20, 0x00, 0x20, 0x00, 0x20};
...
uint8_t bluetoothGame1[BLUETOOTHMESSAGESIZE] = {0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03,
...
void load_and_send_bluetooth2() {
	...
	bluetoothGame2[4] = target2_hit;
	bluetoothGame2[5] = target2_miss;
	bluetoothGame2[8] = target3_hit;
	bluetoothGame2[9] = target3_miss;
	bluetoothGame2[12] = target4_hit;
	bluetoothGame2[13] = target4_miss;
	bluetoothGame2[16] = target5_hit;
	bluetoothGame2[17] = target5_miss;
	bluetoothGame2[20] = blade_hit;
	bluetoothGame2[21] = blade_miss;
